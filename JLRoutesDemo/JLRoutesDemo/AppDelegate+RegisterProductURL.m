//
//  AppDelegate+RegisterProductURL.m
//  JLRoutesDemo
//
...
#import "AppDelegate+RegisterProductURL.h"
#import "UserInformationViewController.h"

@implementation AppDelegate (RegisterProductURL)

- (void)productApplication:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    
    [JLRoutes addRoute:@"/product/:object" handler:^BOOL(NSDictionary * _Nonnull parameters) {
        ...
        userInfoVC.parseURLString = [NSString stringWithFormat:@"object:%@\n  primaryKey:%@\n debug:%@\n foo:%@,RouteURL:%@\n,RoutePattern:%@\n,RoutesnameSpace:%@",object,@(primaryKey),debug?@"true":@"false",foo,JLRouteURL,JLRoutePattern,JLRouteNamespace];
        
        [nav pushViewController:userInfoVC animated:YES];
        return YES;
    }];
    
    [[JLRoutes routesForScheme:@"Product" ] addRoute:@"/:object" handler:^BOOL(NSDictionary * _Nonnull parameters) {
        NSString *JLRouteURL = parameters[@"JLRouteURL"];
        NSString *JLRoutePattern = parameters[@"JLRoutePattern"];
        NSString *JLRouteNamespace = parameters[@"JLRouteNamespace"];
